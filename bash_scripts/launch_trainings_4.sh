...
# python3 code/scripts/train_treadmill_agent_jax_reward_gated_logits_hidden_credit.py \
#     --config training_configs/persistence_gated_exp_gru_initial_prob_offset_hidden.json \
#     --n_networks 1

python3 code/scripts/train_treadmill_agent_jax_value_bootstrap.py \
    --config training_configs/r_minus_rate_value_bootstrap_exp_gru_initial_prob_offset_v2.json \
    --n_networks 1
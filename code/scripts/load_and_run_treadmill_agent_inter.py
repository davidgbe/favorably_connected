...
from aux_funcs import zero_pad, make_path_if_not_exists, compressed_write, compressed_read, load_first_json, random_orthogonal_vector
import optuna
...
parser.add_argument('--ortho', metavar='or', type=int, default=0)
parser.add_argument('--scale_factor', metavar='sf', type=float, default=0)

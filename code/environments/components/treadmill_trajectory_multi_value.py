...
from agents.a2c_rnn_flax_multihead_value import A2CRNNFlax
...
def collect_trajectory(
    ...
    def scan_step(carry, _):
        ...
        logits, values, new_actor_hidden, new_critic_hidden, pred_env_quality, actor_values = network.apply(
            train_state.params,
            network_input,
